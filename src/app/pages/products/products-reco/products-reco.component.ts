...
@Component({
  selector: 'app-products-reco',
  templateUrl: './products-reco.component.html',
  styleUrls: ['./products-reco.component.css']
})
export class ProductsRecoComponent implements OnInit {
