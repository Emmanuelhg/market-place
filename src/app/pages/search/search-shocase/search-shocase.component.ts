...
@Component({
  selector: 'app-search-shocase',
  templateUrl: './search-shocase.component.html',
  styleUrls: ['./search-shocase.component.css']
})
export class SearchShocaseComponent implements OnInit {
