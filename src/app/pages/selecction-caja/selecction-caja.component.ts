...
export class SelecctionCajaComponent implements OnInit {
  ...
  'caja izquierda',
  'caja derecha', 0, 0, 'null','null', 'null','null','null','null',0,0,0,0
  ];
  ...
  ngOnInit(): void {
    ...
    .subscribe(resp =>{
      ...
      console.log("url images es:", resp);
      this.urlsImgs = resp;
 ...
 console.log("Esto es el id to box:",this.id_to_box);
   ...
   newBoxes(){
      ...
      switch(this.type_box){
        case 0: {
          ...
          this.boxes.box_cant=this.urlsImgs[12];
        ...
        case 1: {
          ...
          this.boxes.box_cant=this.urlsImgs[13];
        }
  ...
  fncBorder(){
    ...
    if(this.type_box==0){
      document.getElementById("img_izquierda").style.border ="thick solid #6a6a6a";
    }else{
      document.getElementById("img_izquierda").style.border ="";
    }

    if(this.type_box==1){
      document.getElementById("img_derecha").style.border ="thick solid #6a6a6a";
    }else{
